...
context "Handle Events" do
  context "Initiated" do
    context "Withdraw" do
      ...
      withdraw_client.clock.now = processed_time
      ...
      context "Metadata" do
        test "reply_stream_name is the funds transfer's command stream name" do
          assert(withdraw.metadata.reply_stream_name == funds_transfer_command_stream_name)
        end
